...
public class ComputerPlayer {
    ...
    public int chooseSuit(List<Card> hand) {
        ...
        if (numClubs > numDiamonds && numClubs > numHearts &&
                numClubs > numSpades) {
            suit = 200;
        } else if (numHearts > numDiamonds && numHearts >
                numClubs && numHearts > numSpades) {
            suit = 300;
        } else if (numSpades > numDiamonds && numSpades >
                numClubs && numSpades > numHearts) {
            suit = 400;
        }
        return suit;
    }
